...
<div class="bg-dark-bg flex min-h-screen items-center justify-center">
  <div class="w-full max-w-sm p-4">
    ...
    <div class="mb-8 text-center">
      ...
      <p class="text-dark-text-muted text-sm">Sign in to your workspace</p>
    </div>
    ...
    <Card>
      ...
      <form onsubmit={handleEmailLogin} class="space-y-4">
        ...
        <Button type="submit" {loading} disabled={loading} class="w-full">Sign in</Button>
      </form>

      <div class="relative my-6">
        <div class="absolute inset-0 flex items-center">
          <div class="border-light-border w-full border-t"></div>
        </div>
        <div class="relative flex justify-center text-xs">
          <span class="bg-light-bg text-light-text-muted px-2">or</span>
        </div>
      </div>
      ...
      <button
        ...
        disabled={loading}
        class="border-light-border-strong bg-light-bg text-light-text hover:bg-light-bg-hover flex w-full items-center justify-center
               gap-3 rounded-lg border px-4 py-2.5 text-sm font-medium shadow-sm
    ...
    <p class="text-dark-text-dimmed mt-6 text-center text-xs">
      By continuing you agree to our
      <a href="https://muscle.oute.pro/terms" class="text-primary-400 hover:underline"
        >Terms of Service</a
      >.
    </p>
  </div>
